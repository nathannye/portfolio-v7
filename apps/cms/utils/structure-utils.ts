...
export function setupPages(S: StructureBuilder, context: any) {
	...
	const orderablePageList = (title: string, schema: string, icon?: IconType) => {
	...
	return { singlePage, pageList, folder, div, orderablePageList }
}
